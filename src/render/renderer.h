...
protected:
    ...
    static glm::vec3 computeToneShading(const glm::vec3& color, const volume::GradientVoxel& gradient, const glm::vec3& lightDirection, const glm::vec3& viewDirection, float alpha, float beta);
    static float computeContour(const volume::GradientVoxel& gradient, const glm::vec3& viewDirection, float epsilon);
